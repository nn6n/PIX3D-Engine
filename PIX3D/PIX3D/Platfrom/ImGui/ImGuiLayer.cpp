...
void PIX3D::ImGuiLayer::Init()
{
	// Setup Dear ImGui context
		...
		ImGui_ImplGlfw_InitForOpenGL((GLFWwindow*)PIX3D::Engine::GetPlatformLayer()->GetNativeWindowHandel(), true);
...
void PIX3D::ImGuiLayer::EndDraw()
{
	ImGui::Render();
	ImGui_ImplOpenGL3_RenderDrawData(ImGui::GetDrawData());
}

void PIX3D::ImGuiLayer::StartDockSpace()
{
...
void PIX3D::ImGuiLayer::EndDockSpace()
{
	ImGui::End();
}
